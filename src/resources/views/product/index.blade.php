            ...
            <div class="align-self-center">
                <ul class="list-group list-group-horizontal bg-transparent border-0">
                    <li class="list-group-item bg-transparent border-0 p-0">
                        <a href="{{ route('product.create') }}" class="btn btn-success">{{ __('Add New') }}</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <table id="tbl-list" class="table table-app">
                <thead>
                    <tr class="px-2">
                        ...
                        <th class="text-center fs-mona fs-mona-semibold" scope="col" width="100"></th>
                        ...
                        <th class="text-center fs-mona fs-mona-semibold" scope="col" width="300">{{ __('Categories') }}</th>
